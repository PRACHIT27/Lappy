...
{
    public partial class Modelfinallyadded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyModelId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Laptops", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Laptops_Companies_CompanyModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LaptopModelId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CartDetails_Laptops_LaptopModelId",
                        column: x => x.LaptopModelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartDetails_LaptopModelId",
                table: "CartDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Laptops_CompanyModelId",
                table: "Laptops",
